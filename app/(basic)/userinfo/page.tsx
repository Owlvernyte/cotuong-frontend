        ...
        <div id="user_info"
          className=" bg-primary rounded-md shadow-lg w-1/2 h-1/3 float-left" style={{marginLeft:'2%'}}>
            <div className='text-bamboo-100 flex items-center table-auto'>
                <div>
                    <div className='table-cell'><img src='/avatars/1.png'className='h-20 rounded-full' ></img></div>
                        <div className='table-cell'>
                            <div className='inline-block float-left ml-3'>
                                <div className='ml-10'>
                                Owlvernyte
                                <img src='/flags/vietnam.png' className='float-right h-8 ml-3'></img>
                                </div>
                            <div>
                                1234 
                    ...
                    <div className="dropdown dropdown-end bg-bamboo-100 mt-2 w-60">
                        ...
                        >
                            <li className='bg-bamboo-100 text-dirt-200'>
                                <button><img src='/flags/england.png' className='h-10 w-20'></img>Anh</button>
                                <button><img src='/flags/usa.png' className='h-10 w-20'></img>Mỹ</button>
                            </li>
                        </ul>
                    </div>
                </div>
