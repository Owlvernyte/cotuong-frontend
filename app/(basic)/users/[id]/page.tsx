  ...
  return (
    ...
    <div className="h-full space-y-2 flex flex-col">
      <div className="grid grid-cols-8 gap-2 grid-flow-row-dense flex-1 h-full">
        <div id="user-info" className="col-span-6 space-y-2 h-full pb-2">
          <div id="info" className="card bg-bamboo-400 rounded-md w-full h-1/2">
            ...
            <div className="card-body">
              <div className="my-2">
                <div className="flex items-center space-x-2 py-2">
                  <div className="text-bamboo-100 text-xl">Chọn Quốc Gia</div>
                  <select
                ...
                <div className="my-2">
                  ...
                  <div className="flex space-x-4 items-center">
                    <button className="hover:blur-sm">
                      <Image
        ...
        >
          <div className="card-body">
            <div className="flex justify-between items-center">
              <div className="text-2xl text-bamboo-100">Bạn Bè</div>
              <Button
                text="Thêm Bạn"
                ...
                onClick={() => (window as any).modal_add_friend.showModal()}
              />
              <dialog id="modal_add_friend" className="modal">
                <div className="modal-box w-full bg-bamboo-400">
                  <form method="dialog">
                    ...
                    />
                    <h3 className="text-3xl text-bamboo-100 py-4">Kết Bạn</h3>
                    <div className="px-4">
                      <input
                        type="text"
                        name="searchUsername"
